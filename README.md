...
Repositório para trabalho final da matéria Análise de Sobrevivência, como parte do programa de Pós-Graduação em Estatística pela Universidade de Brasília. 

Professor Frederico Machado Almeida.

Alunos Guilherme Braga e Vinicius Paiva. Entrega limite para 13 de julho de 2026.
...
No notebook *ttt.rmd* é feito o gráfico TTT do conjunto de dados original.

Os notebooks *gama.Rmd* e *bs.Rmd* reproduzem os resultados para modelo de fragilidade apresentado no artigo Leão et al., enquanto que o notebook *abordagem_param.Rmd* apresenta abordagens paramétricas clássicas além de um modelo de Cox tradicional para analisar os dados, com e sem uso de covariáveis disponíveis. 

O arquivo *veternos.txt* é uma réplica dos dados utilizados, originalmente disponibilizado pelo professor Frederico Machado Almeida via ambiente Aprender3.
